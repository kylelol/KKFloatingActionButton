#
#  Be sure to run `pod spec lint KKFloatingActionButton.podspec' to ensure this is a
...
#s.description  = <<-DESC
  ...
  s.homepage     = "http://github.com/kylelol/KKFloatingActionButton"
  ...
  s.author             = { "kylelol" => "kyle.kirkland0528@me.com" }
  # Or just: s.author    = "kylelol"
  # s.authors            = { "kylelol" => "kyle.kirkland0528@me.com" }
  # s.social_media_url   = "http://twitter.com/kylelol"
